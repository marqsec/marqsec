...
> 🇷🇺 **[MARQSEC]: Движок анализа и защиты. Разработчик, сфокусированный на автоматизации пентестинга и создании tools для обороны и атаки.**
> 
...
| Область | Описание |
| :--- | :--- |
| ⚔️ **Offensive Security** | Наступательная Безопасность |
| 🛡️ **Defensive Security** | Оборонительная Безопасность |
| 🐍 **Tool Development** | Разработка скриптов на Python/Go |
